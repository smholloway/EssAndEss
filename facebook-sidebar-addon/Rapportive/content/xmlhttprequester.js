function rapportive_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
rapportive_xmlhttpRequester.prototype.contentStartRequest = function(details) {
    ...
    switch (scheme) {
        ...
        case "ftp":
            this.chromeWindow.setTimeout(
                rapportive_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
            break;
        default:
...
rapportive_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
rapportive_xmlhttpRequester.prototype.setupRequestEvent =
